...
class StudentApiService {
  ...
  static const String _baseUrl = 'http://10.0.2.2:3000';////// aqui el primer error que estaba direccionanado a 30007 y era solo 300
  ...
  Future<List<Student>> fetchStudents() async {
    try {
      ...
      if (response.statusCode == 200) {  //// aqui estaba el segundo error era un = no una interrogacion
...
}///// este es el bug 3 era un punto y no cerraba 
